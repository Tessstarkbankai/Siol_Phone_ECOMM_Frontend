    ...
    <section id="faq" className="py-14 sm:py-20 bg-white border-b border-slate-100">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-10 space-y-3">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-slate-100 border border-slate-200 px-3 py-1 text-xs font-bold uppercase tracking-wider text-slate-700">
          ...
          <p className="text-sm text-slate-600">
            Clear, authoritative answers to common smartphone setup, repair timelines, and warranty terms.
          </p>
        </div>
