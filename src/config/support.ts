...
export const AUTHORIZED_SERVICE_CENTERS: ServiceCenter[] = [
  ...
  {
    id: "sc-mum-2",
    name: "SiOL West Suburban Authorized Care Point",
    city: "Mumbai",
    state: "Maharashtra",
    pincode: "400050",
    address: "Shop 14, Kenilworth Arcade, Linking Road, Bandra West",
    landmark: "Near KFC Junction",
    phone: "+91 1800 123 4568",
    email: "bandra.service@siol.in",
    ...
    services: [
      "Express Display & Glass Replacement",
      "Battery Diagnostic & Replacement",
  ...
  {
    id: "sc-mum-3",
    name: "SiOL North Mumbai Express Tech Hub",
    city: "Mumbai",
    state: "Maharashtra",
    pincode: "400069",
    address: "Ground Floor, Solitaire Corporate Park, Andheri-Ghatkopar Link Road, Andheri East",
    landmark: "Adjacent to Chakala Metro Station",
    phone: "+91 1800 123 4569",
    email: "andheri.service@siol.in",
    timing: "10:00 AM – 7:30 PM",
    openDays: "Open All 7 Days",
    mapsUrl: "https://maps.google.com/?q=Andheri+East+Mumbai",
    isFlagshipLounge: false,
    services: [
      "Same-Day Diagnostics",
      "Speaker & Mic Ultrasonic Cleaning",
      "Firmware & OS Re-Flashing",
  ...
  {
    id: "sc-del-2",
    name: "SiOL South Delhi Authorized Care Point",
    city: "New Delhi",
    state: "Delhi NCR",
    pincode: "110019",
    address: "Shop 302, 3rd Floor, Devika Tower, Nehru Place IT Hub",
    landmark: "Opposite Nehru Place Metro Station",
    phone: "+91 1800 123 4570",
    email: "nehruplace.service@siol.in",
    ...
    services: [
      ...
      "Display Glass & Touch Layer Service",
  ...
  {
    id: "sc-del-3",
    name: "SiOL NCR Horizon Authorized Hub",
    city: "New Delhi",
    state: "Delhi NCR",
    pincode: "122002",
    address: "Unit 12, Ground Floor, Building 10, DLF Cyber City, Gurugram",
    landmark: "Near Cyber City Rapid Metro",
    phone: "+91 1800 123 4571",
    email: "gurugram.service@siol.in",
    timing: "09:30 AM – 8:00 PM",
    openDays: "Open All 7 Days",
    mapsUrl: "https://maps.google.com/?q=DLF+Cyber+City+Gurugram",
    isFlagshipLounge: true,
    services: [
      "Express 90-Min Repair Guarantee",
      "Laser Back Glass Replacement",
      "IP68 Vacuum Seal Testing",
      "Corporate Device Fleet Support",
    ],
  },
  ...
  {
    id: "sc-blr-2",
    name: "SiOL Koramangala Premier Service Point",
    city: "Bengaluru",
    state: "Karnataka",
    pincode: "560095",
    address: "88, 5th Block, Jyoti Nivas College Road, Koramangala",
    landmark: "Near Empire Restaurant Junction",
    phone: "+91 1800 123 4572",
    email: "koramangala.service@siol.in",
    timing: "10:30 AM – 8:00 PM",
    openDays: "Mon – Sat (Closed Sunday)",
    mapsUrl: "https://maps.google.com/?q=Koramangala+5th+Block+Bengaluru",
    isFlagshipLounge: false,
    services: [
      "AMOLED Display Replacement",
      "Thermal Pad & Paste Refresh",
  ...
  {
    id: "sc-blr-3",
    name: "SiOL Whitefield Express Care Center",
    city: "Bengaluru",
    state: "Karnataka",
    pincode: "560066",
    address: "Level 1, The Forum Neighbourhood Mall, Whitefield Main Road",
    landmark: "Opposite Prestige Ozone",
    phone: "+91 1800 123 4573",
    email: "whitefield.service@siol.in",
    timing: "10:00 AM – 8:30 PM",
    openDays: "Open All 7 Days",
    mapsUrl: "https://maps.google.com/?q=Whitefield+Bengaluru",
    isFlagshipLounge: false,
    services: [
      "Same-Day Quick Repairs",
  ...
  {
    id: "sc-hyd-2",
    name: "SiOL Jubilee Hills Luxury Service Point",
    city: "Hyderabad",
    state: "Telangana",
    pincode: "500033",
    address: "Plot 420, Road Number 36, Jubilee Hills",
    landmark: "Near Peddamma Temple Metro Station",
    phone: "+91 1800 123 4574",
    email: "jubileehills.service@siol.in",
    timing: "10:30 AM – 8:00 PM",
    openDays: "Open All 7 Days",
    mapsUrl: "https://maps.google.com/?q=Road+36+Jubilee+Hills+Hyderabad",
    isFlagshipLounge: false,
    services: [
      "Curved Display Alignment",
      "Liquid Damage Assessment",
      "Battery Diagnostic & Replacement",
      "Factory Data Backup Support",
    ],
  },
  {
    id: "sc-hyd-3",
    name: "SiOL Secunderabad Authorized Care Hub",
    city: "Hyderabad",
    state: "Telangana",
    pincode: "500003",
    address: "24-A, Mahatma Gandhi Road, Secunderabad",
    landmark: "Opposite Clock Tower",
    phone: "+91 1800 123 4575",
    email: "secunderabad.service@siol.in",
    timing: "10:00 AM – 7:00 PM",
    openDays: "Mon – Sat (Closed Sunday)",
    mapsUrl: "https://maps.google.com/?q=MG+Road+Secunderabad",
    isFlagshipLounge: false,
    services: [
      "Official Screen Swap",
      "Speaker Module Repair",
      "Antenna & 5G Signal Testing",
  ...
  {
    id: "sc-chn-2",
    name: "SiOL T. Nagar Flagship Care Pavilion",
    city: "Chennai",
    state: "Tamil Nadu",
    pincode: "600017",
    address: "44, South Usman Road, T. Nagar",
    landmark: "Beside Panagal Park",
    phone: "+91 1800 123 4576",
    email: "tnagar.service@siol.in",
    timing: "10:00 AM – 8:00 PM",
    openDays: "Open All 7 Days",
    mapsUrl: "https://maps.google.com/?q=T+Nagar+Chennai",
    isFlagshipLounge: true,
    services: [
      "1-Hour Display Swaps",
      "Factory Vacuum Waterproof Sealing",
      "Battery Calibration",
      "Motherboard Repair",
    ],
  },
  {
    id: "sc-chn-3",
    name: "SiOL OMR Express Tech Center",
    city: "Chennai",
    state: "Tamil Nadu",
    pincode: "600096",
    address: "Ground Floor, ASV Suntech Park, OMR Thoraipakkam",
    landmark: "Near Toll Gate",
    phone: "+91 1800 123 4577",
    email: "omr.service@siol.in",
    timing: "09:30 AM – 7:30 PM",
    openDays: "Mon – Sat (Closed Sunday)",
    mapsUrl: "https://maps.google.com/?q=OMR+Thoraipakkam+Chennai",
    isFlagshipLounge: false,
    services: [
      "Express 2-Hour Service",
      "Fast Charging Port Repair",
      "Software Flash & Recovery",
  ...
  {
    id: "sc-kol-2",
    name: "SiOL Salt Lake Sector V Tech Care Hub",
    city: "Kolkata",
    state: "West Bengal",
    pincode: "700091",
    address: "Block GP, Sector V, Salt Lake Electronics Complex",
    landmark: "Near College More Metro Station",
    phone: "+91 1800 123 4578",
    email: "saltlake.service@siol.in",
    timing: "10:00 AM – 7:30 PM",
    openDays: "Mon – Sat (Closed Sunday)",
    mapsUrl: "https://maps.google.com/?q=Sector+V+Salt+Lake+Kolkata",
    isFlagshipLounge: false,
    services: [
      "Quick Display Repair",
      "Battery Degradation Diagnosis",
      "Camera Sensor Lens Cleaning",
      "Official Accessory Check",
    ],
  },
  {
    id: "sc-kol-3",
    name: "SiOL South Kolkata Authorized Care Point",
    city: "Kolkata",
    state: "West Bengal",
    pincode: "700029",
    address: "128, Rashbehari Avenue, Gariahat Crossing",
    landmark: "Near Triangular Park",
    phone: "+91 1800 123 4579",
    email: "gariahat.service@siol.in",
    timing: "10:30 AM – 7:30 PM",
    openDays: "Mon – Sat (Closed Sunday)",
    mapsUrl: "https://maps.google.com/?q=Gariahat+Kolkata",
    isFlagshipLounge: false,
    services: [
      "Same-Day Display Swaps",
      "Charging Port & Cable Testing",
      "Speaker Dust Clearance",
      "Warranty Verification",
    ],
  },
  ...
  {
    id: "sc-pun-2",
    name: "SiOL Baner High Street Authorized Care Point",
    city: "Pune",
    state: "Maharashtra",
    pincode: "411045",
    address: "Unit 3, Balewadi High Street, Baner",
    landmark: "Near Cummins India Office",
    phone: "+91 1800 123 4580",
    email: "baner.service@siol.in",
    timing: "10:30 AM – 8:00 PM",
    openDays: "Open All 7 Days",
    mapsUrl: "https://maps.google.com/?q=Balewadi+High+Street+Baner+Pune",
    isFlagshipLounge: false,
    services: [
      "Express Display Service",
      "Battery Health Calibration",
      "Water Resistance Pressure Check",
      "Micro-Soldering Support",
    ],
  },
  {
    id: "sc-pun-3",
    name: "SiOL Shivaji Nagar Express Care Center",
    city: "Pune",
    state: "Maharashtra",
    pincode: "411004",
    address: "Shop 10, FC Road, Shivaji Nagar",
    landmark: "Near Goodluck Cafe Chowk",
    phone: "+91 1800 123 4581",
    email: "shivajinagar.service@siol.in",
    timing: "10:00 AM – 7:30 PM",
    openDays: "Mon – Sat (Closed Sunday)",
    mapsUrl: "https://maps.google.com/?q=FC+Road+Shivaji+Nagar+Pune",
    isFlagshipLounge: false,
    services: [
      "Display & Glass Replacement",
      "Type-C Port & Mic Servicing",
      "OS Troubleshooting",
      "Doorstep Pickup Drop-Off Point",
    ],
  },
];
...
export const POPULAR_CITIES_DATA: PopularCityItem[] = [
  {
    ...
    cityName: "Mumbai",
    state: "Maharashtra",
    tagline: "Flagship Experience Lounge & City Care Hubs",
    ...
    centerIds: ["sc-mum-1", "sc-mum-2", "sc-mum-3"],
  },
  {
    id: "city-delhi",
    cityName: "New Delhi",
    state: "Delhi NCR",
    tagline: "Central Care Pavilion & Metro Service Points",
    // Can be replaced with Google Drive or CDN image URL:
    imageUrl: "https://images.unsplash.com/photo-1587474260584-136574528ed5?q=80&w=1000&auto=format&fit=crop",
    centerIds: ["sc-del-1", "sc-del-2", "sc-del-3"],
  },
  {
    id: "city-bengaluru",
    cityName: "Bengaluru",
    state: "Karnataka",
    tagline: "Tech Lounges & Silicon Valley Hubs",
    // Can be replaced with Google Drive or CDN image URL:
    imageUrl: "https://images.unsplash.com/photo-1596176530529-78163a4f7af2?q=80&w=1000&auto=format&fit=crop",
    centerIds: ["sc-blr-1", "sc-blr-2", "sc-blr-3"],
  },
  {
    id: "city-hyderabad",
    cityName: "Hyderabad",
    state: "Telangana",
    tagline: "Cyber Gateway & Twin Cities Service Network",
    // Can be replaced with Google Drive or CDN image URL:
    ...
    centerIds: ["sc-hyd-1", "sc-hyd-2", "sc-hyd-3"],
  },
  {
    id: "city-chennai",
    cityName: "Chennai",
    state: "Tamil Nadu",
    tagline: "Anna Nagar, T. Nagar & OMR Care Centers",
    // Can be replaced with Google Drive or CDN image URL:
    imageUrl: "https://images.unsplash.com/photo-1582510003544-4d00b7f74220?q=80&w=1000&auto=format&fit=crop",
    centerIds: ["sc-chn-1", "sc-chn-2", "sc-chn-3"],
  },
  {
    id: "city-kolkata",
    cityName: "Kolkata",
    state: "West Bengal",
    tagline: "Park Street & Salt Lake IT Hubs",
    // Can be replaced with Google Drive or CDN image URL:
    imageUrl: "https://images.unsplash.com/photo-1558431382-27e303142255?q=80&w=1000&auto=format&fit=crop",
    centerIds: ["sc-kol-1", "sc-kol-2", "sc-kol-3"],
  },
  {
    id: "city-pune",
    cityName: "Pune",
    state: "Maharashtra",
    tagline: "Koregaon Park, Baner & FC Road Lounges",
    // Can be replaced with Google Drive or CDN image URL:
    ...
    centerIds: ["sc-pun-1", "sc-pun-2", "sc-pun-3"],
  },
];
...
> = {
  smartphone: {
    ...
    steps: [
      ...
      {
        stepNumber: "02",
        title: "Choose How You Want to Repair",
        subtitle: "Choose a service option",
        description: "Visit a service centre or choose available repair options for your device.",
        imageUrl: "./2.png",
        highlightBadge: "Flexible Options",
      },
      {
        stepNumber: "03",
        title: "Professional Repair & Care",
        subtitle: "Factory precision",
        description: "Your device is checked and serviced by trained service professionals.",
        imageUrl: "./3.png",
        highlightBadge: "Genuine Parts",
      },
      {
        stepNumber: "04",
        title: "Checked Before It’s Returned",
        subtitle: "Ready for you",
        description: "Your device is tested after service so you know it’s ready to use.",
        imageUrl: "./4.png",
